...
import { LayoutNewBarberProps } from "./NewBarber.types";

export default function NewBarberLayout({ handlers, variables }: LayoutNewBarberProps) {
        ...
        <Flex background="barber.900" minH="100vh" alignItems="center" justifyContent="flex-start" direction="column">
          ...
          <Flex pt={8} pb={8} maxW="1200px" w="100%" direction="column" >
            ...
            <Flex w="100%" bg="barber.400" align="center" justify="center" pt={8} pb={8} direction="column" rounded={4}>
              ...
              <Button
                isLoading={variables?.loader} onClick={handlers?.handleRegisterBarber} w="85%" mb={6} mt={3} bg="button.cta" size="lg" _hover={{ bg: '#ffb13e' }}
              >
                Cadastrar
              </Button>
